// NB This file is auto-generated via the Sp.Product-Demoapp_10 NuGet package.
...
namespace Sp.Agent
{
	static class SpProduct
	{
		...
		public const string Name = @"DemoApp";
...
{
	/// <summary>Defines features and properties associated with the Software Potential Product Definition for 'DemoApp' - '1.0'</summary>
	static partial class @Demoapp_10
	{
		...
		{
			#region Feature3
			/// <summary>Require a License for 'DemoApp' - '1.0' with the 'Name: Feature3' Feature to be present.</summary>
			...
			#region Feature2
			/// <summary>Require a License for 'DemoApp' - '1.0' with the 'Name: Feature2' Feature to be present.</summary>
			[System.AttributeUsage( System.AttributeTargets.Constructor | System.AttributeTargets.Method )]
			...
			#region Feature1
			/// <summary>Require a License for 'DemoApp' - '1.0' with the 'Name: Feature1' Feature to be present.</summary>
			[System.AttributeUsage( System.AttributeTargets.Constructor | System.AttributeTargets.Method )]
		...
		/// <summary>Require any License for 'DemoApp' - '1.0' to be present.</summary>
		[System.AttributeUsage( System.AttributeTargets.Constructor | System.AttributeTargets.Method )]
