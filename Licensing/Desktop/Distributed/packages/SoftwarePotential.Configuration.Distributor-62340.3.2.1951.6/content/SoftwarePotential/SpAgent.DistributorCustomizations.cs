...
namespace Sp.Agent
{
#if !DISABLE_SP_AGENT_DISTRIBUTOR_WRITABLE_CONFIGURATION_FILE
	/// <summary>
	...
	static partial class SpAgent
	{
		...
		{
			// NB we are reliant on Installation having been completed to be able to touch the configuration file.
			// This code can get called as part of installation, so we add a Lazy layer to ensure the initialization doesn't happen too early
	...
	/// </summary>
	/// <remarks>
	/// NB using this precludes usaing the following facilities 
	/// - using WritableApplicationConfigFile (i.e. you'll need to maintain your own Distributor Base Uri e.g. like SP_AGENT_DISTRIBUTOR_READONLY_CONFIG_IN_APP_CONFIG)
	/// - Checking out Licenses
	/// - Using locally installed Licenses
	/// </remarks>
	static partial class SpAgent
	{
		// Stub out any storage for licenses or config files on the local machine - assume all state will be maintained on a continually available Distributor
