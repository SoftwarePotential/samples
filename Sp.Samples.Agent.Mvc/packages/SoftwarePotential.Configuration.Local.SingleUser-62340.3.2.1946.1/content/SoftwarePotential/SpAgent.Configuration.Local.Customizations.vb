...
Partial Class SpAgent
    ...
    Private Shared Sub ConfigureLocalStorePath(rootPath As String, vendor As String, product As String, version As String, overridePath As Action(Of String, String))
        '=======================================================================================================
