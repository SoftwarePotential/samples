...
#If USING_NAMED_USERS Then
    ...
    '' <para>see http://docs.softwarepotential.com/Configuration.Distributor-README.html for further details on Named User licensing</para>
    '' </summary>
    '' <param name="configure"></param>
    Private Shared Sub ConfigureNamedUserDiscovery(configure As Action(Of Func(Of String)))
        configure(Function() As String
                      Return String.Empty
                  End Function)
    End Sub
#End If
