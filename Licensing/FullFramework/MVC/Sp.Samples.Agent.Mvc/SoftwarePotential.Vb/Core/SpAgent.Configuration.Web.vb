...
Partial Class SpAgent
    ...
    Private Shared Sub ConfigureLocalBoundStorage(configure As Action(Of Func(Of IAgentCommenceConfigurationPhase, IAgentHardwareBoundStorageConfigurationPhase)))
