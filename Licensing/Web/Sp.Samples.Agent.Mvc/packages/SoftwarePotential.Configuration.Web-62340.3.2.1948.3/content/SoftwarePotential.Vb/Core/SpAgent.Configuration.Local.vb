...
Partial Class SpAgent
	...
	''' </summary>
	Public Shared Function ConfiguredExternallyManagedRootPath() As String
	...
	''' </summary>
	Public Shared Function ConfiguredBaseAndRelativePathElements() As Tuple(Of String, String)
